...
//    console.log(data);
    ...
    const newPage = await page.evaluate(() => {
        return document.getElementById('value_00_0010_7351_0100-006_2_0').innerHTML;  
    });
...
async function insertData(){
    ...
    const sequelize = new Sequelize(process.env.DB_DB, process.env.DB_USER, process.env.DB_PASS, {
      ...
      const SpeicherTemp = sequelize.define('oventrop_temp', {
        temp: {
      ...
      .then(() => {
        ...
        SpeicherTemp.bulkCreate([
          myobjs[0]
        ]).then(function () {
          return SpeicherTemp.findAll();
        }).then(function (oventrop_temp) {
          console.log(oventrop_temp);
        });
      });
}